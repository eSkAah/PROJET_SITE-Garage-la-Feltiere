...
<h1 class="col-sm-6 offset-3  col-12 mb-3 mt-3"><span>VÉHICULES VENDUES</span></h1>
        ...
        <table class="table table-striped table-dark mt-4">
            ...
            <tbody>
                ...
                $statement = $db->query('SELECT * 
                                            FROM items 
                                            WHERE category = "voitures_vendues"
                ...
                echo '<tr>';
                    ...
                    echo ' ';
                        echo '<a   class="btn-sm btn-danger" href="voitures/delete.php?id=' . $item['id'] . '"><i class="far fa-trash-alt"></i> Supprimer</a>';
                    echo '</td>';
                echo '</tr>';
